...
// DexScreener has open CORS + pump.fun WS works from the browser, so we hit them
// DIRECTLY (never via the proxy) — that keeps the live feed working even if the
// backend is asleep. Only RugCheck / Meteora / Helius need the proxy (CORS + keys).
const dsBase = () => "https://api.dexscreener.com";
  ...
  useEffect(() => {
    ...
    if (CONFIG.PUMPPORTAL) {
      try {
        ...
        const wsUrl = "wss://pumpportal.fun/api/data"; // direct — works browser-side, no backend needed
